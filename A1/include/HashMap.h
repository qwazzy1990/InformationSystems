...
#define destroy_mapnode(myarg) destroy_mapnode_real(&myarg)
...
/**
 *giving names to pointers of hashelement. Pointer to hash element is a MapNode
 *and pointers to pointers of hashelemnts. Pointer to a MapNode is MapMapNodes. Used to create table
 * **/
typedef HashElement* MapNode;
typedef MapNode* MapNodes;
...
typedef Map* HashMap;
		...
		/**
		 * Function to create a MapNode for the HashMap
